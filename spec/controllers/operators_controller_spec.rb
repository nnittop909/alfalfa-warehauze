  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created operator as @operator" do
        ...
        expect(assigns(:operator)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved operator as @operator" do
        post :create, {:operator => invalid_attributes}, valid_session
        expect(assigns(:operator)).to be_a_new(Operator)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested operator" do
        operator = Operator.create! valid_attributes
        put :update, {:id => operator.to_param, :operator => new_attributes}, valid_session
        operator.reload
    ...
    context "with invalid params" do
      it "assigns the operator as @operator" do
        operator = Operator.create! valid_attributes
        put :update, {:id => operator.to_param, :operator => invalid_attributes}, valid_session
        expect(assigns(:operator)).to eq(operator)
      end

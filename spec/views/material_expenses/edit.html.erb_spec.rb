...
RSpec.describe "material_expenses/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit material_expense form" do
    render

    assert_select "form[action=?][method=?]", material_expense_path(@material_expense), "post" do

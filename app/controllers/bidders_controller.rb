class BiddersController < ApplicationController
  ...
  def new
    ...
    @bidder = @project.bidders.build
  end

  # GET /bidders/1/edit
  def edit
    @project = Projct.find(params[:project_id])
  end
  ...
  def create
    @project = Project.find(params[:project_id])
    @bidder = @project.bidders.create(bidder_params)

    respond_to do |format|
      if @bidder.save
        format.html { redirect_to @project, notice: 'Bidder was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @bidder.update(bidder_params)
        format.html { redirect_to @project, notice: 'Bidder was successfully updated.' }
  ...
  def destroy
    ...
    @bidder.destroy
    respond_to do |format|
      format.html { redirect_to @bidder.project, notice: 'Bidder was successfully destroyed.' }
  ...
  private
    ...
    def bidder_params
      params.require(:bidder).permit(:name)
    end
end

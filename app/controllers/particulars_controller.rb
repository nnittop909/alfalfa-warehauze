class ParticularsController < ApplicationController
  ...
  def new
    ...
    @particular = @petty_cash.particulars.build
  end
  ...
  def create
    @petty_cash = PettyCash.find(params[:petty_cash_id])
    @particular = @petty_cash.particulars.create(particular_params)

    respond_to do |format|
      if @particular.save
        format.html { redirect_to @petty_cash, notice: 'Particular was successfully created.' }
  ...
  def destroy
    ...
    @particular.destroy
    respond_to do |format|
      format.html { redirect_to @petty_cash, notice: 'Particular was successfully destroyed.' }
  ...
  private
    ...
    def particular_params
      params.require(:particular).permit(:description, :recipient, :amount)
    end
end
